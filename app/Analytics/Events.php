...
class Events {
    ...
    public static function all(): array {
        return [self::ONBOARDING_COMPLETED, self::QUEST_COMPLETED, self::FOCUS_COMPLETED, self::REVIEW_ANSWERED, self::MISSION_CLAIMED, self::LEVEL_UP, self::BADGE_UNLOCKED];
    }
}
