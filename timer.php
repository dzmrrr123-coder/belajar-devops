        ...
        <div class="col-lg-8">
            <div class="timer-container focus-workspace">
                ...
                <div class="lofi-row" role="group" aria-label="Musik lofi">
                    <button type="button" id="lofiToggle" class="btn btn-cyber-outline btn-sm js-lofi-toggle" aria-pressed="false">
                        <i class="fas fa-headphones me-1" aria-hidden="true"></i><span class="js-lofi-label">Lofi</span>
                    </button>
...
// Lofi engine lives in assets/js/app.js (global Lofi, shared across pages).
