...
<main class="container py-4" role="main">
    ...
    <div class="row g-4 align-items-start">
        <div class="col-lg-4">
            <details class="collapsible-card sticky-top" id="questionFormWrap" style="top: 80px;" aria-labelledby="new-question-heading" open>
                <summary class="collapsible-summary">
                    <span class="collapsible-text"><strong id="new-question-heading">Catat pertanyaan</strong><small>Tanya tanpa memutus fokus</small></span>
            ...
            <script>(function(){var d=document.getElementById('questionFormWrap');if(d&&matchMedia('(max-width:991.98px)').matches){d.removeAttribute('open');}})();</script>
        </div>
        <div class="col-lg-8">
    ...
    <div class="modal-dialog modal-dialog-centered modal-bottom">
        <div class="modal-content">
            <div class="modal-header border-bottom">
                <h2 class="modal-title h6 fw-bold mb-0" id="quizModalLabel">Jadikan kartu kuis</h2>
