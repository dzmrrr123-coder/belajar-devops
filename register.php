...
<main class="auth-wrapper" id="main">
        ...
        <form method="POST" action="register.php<?= ($ref_track !== '' || $ref_user !== '') ? '?' . http_build_query(array_filter(['track' => $ref_track, 'ref' => $ref_user])) : '' ?>" id="registerForm">
            ...
            <div class="row g-2 mb-3">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group">
                        <input type="password" name="confirm_password" id="reg-confirm" class="form-control <?= $field_errors['confirm_password'] ? 'is-invalid' : '' ?>" placeholder="Ulangi sandi" required autocomplete="new-password" aria-describedby="reg-confirm-err reg-match" aria-invalid="<?= $field_errors['confirm_password'] ? 'true' : 'false' ?>">
                    ...
                    <div class="form-text" id="reg-match" role="status"></div>
    ...
    <?php $auth_mode = 'register'; require __DIR__ . '/includes/auth_side.php'; ?>
    </div>
</main>
